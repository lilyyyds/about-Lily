...
- **命名实体识别（NER）和关系抽取（RE）项目**：
    - 深入阅读并研究先进的NER和RE技术，重点关注“命名实体识别的并行实例查询网络”和“辅助指代的文档级关系抽取”。
    - 成功复现并验证实验结果，实现模型并通过严格测试确保准确性。
    - 参与实验室NER基准数据集的开发和维护，确保数据质量和稳定性。
    - 对“AI论文摘要”数据集进行标注，以增强研究能力并提高NER和RE模型的准确性。

- **生物医学信息处理**：
    - 专注于蛋白质-蛋白质相互作用（PPI）研究，阅读并复现“探索杰出的蛋白质相互作用变换器的知识”中的研究成果。
...
- **初期研究阶段（2024年3月25日 - 4月19日）**：
    - 深入阅读生物医学相关论文，包括蛋白质语言模型ESM和ProteinMPNN等最新研究。
    - 深刻理解这些模型的原理、应用场景及其在药物开发和生物医学研究中的潜力和局限性。
    - 研究蛋白质稳定性预测、抗原-抗体亲和力预测以及小分子ADMET特性等任务。
    - [这是我阅读过的一些文章](https://blog.csdn.net/lily_2002_/category_12678844.html).后续因为公司研究方向及保密问题没有继续更新。

- **ADMET预测模块开发（2024年4月22日 - 目前）**：
    - 选择专注于小分子ADMET特性预测，基于其相关性和对公司生物计算平台的重要影响。
    - 数据收集、清洗、模型汇总测试。 
    - 优化算法，确保ADMET预测模块在生物计算平台上的稳定性和准确性。
...
- 利用MMDetection框架运行和评估对象检测模型，包括Faster R-CNN和YOLO。
- 进行比较实验，评估模型在不同数据集上的性能，提供关于其优缺点的见解。
- 优化模型参数以提高检测准确性，为实验室的研究做出贡献。

### **Python编程项目**

- **网络协议分析与数据包过滤**：
    - 使用Python开发工具进行网络协议分析和数据包过滤。
    - 通过实际项目展示在网络安全和协议分析方面的熟练程度。

- **变声器应用**：
    - 设计并实现了一个使用信号处理技术的变声器应用，实现实时音频转换。

### **基于物联网的锂电共享单车智能管理系统**
**前端开发人员**
- 开发了用于管理锂电共享单车的微信小程序界面。
- 集成物联网技术，实现电池实时监控和管理，提升用户体验和运营效率。

## 技能

- **编程语言**：Python, C++
- **数据分析与人工智能**：Pandas, NumPy, Matplotlib, PyTorch, scikit-learn, MMDetection（框架）
- **网页开发**：JavaScript, 微信小程序开发
- **其他**：PPT, Linux, LaTeX, Git, Docker
...
### 科技创新部部长
上海大学通信与信息工程学院学生会，上海，中国  
*2023年9月 - 2024年5月*

- **职责**：
    - 组织部门活动，审核宣传文章，编写活动总结。
    - 策划团队建设活动以增强凝聚力。
    - 与成员进行一对一会面，了解他们的需求并提供支持。

- **主要成就**：
    - **活动管理**：管理项目交流会、期末知识讲座、“互联网+”比赛和挑战杯。
    - **创新举措**：
        - **技能平台**：组织初学者焊接比赛。
        - **竞赛平台**：举办研讨会分享各类竞赛心得。
        - **课程平台**：组织编写宏嘉书院小本本，为课程指导和学习推荐提供资源。
